...
charity_emails = []
   ...
   charities << {image: "", name: "Barnabas Foundation", eid: 362904503, description: "For over 30 years, Barnabas Foundation has been advancing God's kingdom by providing quality planned giving and estate planning services. The goal is to help caring Christians strengthen support for the ministries of almost 200 member organizations. With that goal in mind, Barnabas also offers a stewardship education and development program for churches, known as a FirstFruits. These programs serve as catalysts for churches to grow good stewards, based upon God's ownership of all gifts.",
   mission_statement:"Christian stewardship with excellence", target_area:"USA", video_url: "", video_url_html: "", cover_photo: nil, category_id: charity_categories.find_by_name("Public Benefit").id}
   charity_emails << "Barnabas@groupgrant.com"

   charities << {image: "justice", name: "Administer Justice", eid: 364348917, description: "Founded in 2000, Administer Justice is a legal aid organization serving the needs of low-income and no-income individuals. They operate as a full-time professional law office that also offers other services leading to personal empowerment built on Biblical principles. They provide client appointments and provide educational and outreach services at many community events. Administer Justice provides a wide range of services to meet both the immediate and future needs of low-income individuals facing civil legal matters. Most of their services are available at no cost; some require a one-time nominal administrative fee.",
   mission_statement:"Celebrate Justice", target_area:"Worldwide", video_url: "", video_url_html: "", cover_photo: nil, category_id: charity_categories.find_by_name("Public Benefit").id}
   charity_emails << "justice@groupgrant.com"

   charities << {image: "gleaning", name: "Gleaning for the World", eid: 541930105, description: "Founded in 1998, Gleaning For The World (GFTW) seeks to provide life-saving support to communities in critical need throughout the world by applying a powerful concept that we call gleaning. We provide surplus medical and essential supplies to humanitarian projects worldwide. GFTW provides expedited distribution channels, efficient logistical support and dependable service between corporate donors and mission groups at the lowest possible cost. We believe that all God's children are created equal and are deserving of a compassionate and reliable source of critical supplies, regardless of ethnic, religious or cultural background.",
   mission_statement:"Providing life-saving support to communities in critical need throughout the world", target_area:"Worldwide", video_url: "", video_url_html: "", cover_photo: nil, category_id: charity_categories.find_by_name("International").id}
   charity_emails << "gleaning@groupgrant.com"

   charities << {image: "hagar", name: "Hagar", eid: 201507669, description: "The purpose of Hagar is singular; we restore broken lives. We welcome the toughest of human conditions. We stay focused on the individual. And we do whatever it takes for as long as it takes to restore life in all its fullness. Hagar is a global Christian organization that operates commercial and non-profit entities and engages in private and public sector partnerships in pursuit of its mission to restore women and children who suffer extreme human rights abuse to life in all its fullness.",
   mission_statement:"The whole journey", target_area:"Worldwide", video_url: "", video_url_html: "", cover_photo: nil, category_id: charity_categories.find_by_name("International").id}
   charity_emails << "hagar@groupgrant.com"

   charities << {image: "haiti", name: "God's Littlest Angels", eid: 364149349, description: "God's Littlest Angels is a Haitian orphanage located in the mountains above Petion-Ville, close to the village of Fermathe. The majority of the children brought to the orphanage are between the ages of newborn and 7 years old. We also have older children, sibling groups, and children with special needs waiting for adoptive parents. God's Littlest Angels has ministered to the children of Haiti since 1994 and has been involved in international adoptions since 1997. GLA is involved in several children's ministries in the local community. In the year 2000, GLA implemented a school sponsorship program for children unable to attend school due to the lack of funds. Today, more than 200 children attend school sponsored by people in North America and Europe.",
   mission_statement:"Reaching the people of Haiti", target_area:"Haiti", video_url: "", video_url_html: "", cover_photo: nil, category_id: charity_categories.find_by_name("International").id}
   charity_emails << "littleangels@groupgrant.com"

   charities << {image: "rome", name: "American Academy in Rome", eid: 131623881, description: "The mission of the American Academy in Rome, founded in 1894, is to foster the pursuit of advanced research and independent study in the fine arts and humanities. The Academy awards the Rome Prize to a select group of artists and scholars invited to Rome to pursue their creative goals in an atmosphere conducive to artistic innovation and rigorous scholarship. The Academy provides a multi-disciplinary environment where groups of talented and ambitious artists and scholars come together, influence each other, and contribute to the artistic movements and scholarly culture of their time. Central to its mission are encounters with the Eternal City, deepening and intensifying all the Academy has to offer.",
   mission_statement:"Fostering the pursuit of advanced research and independent study in the fine arts and humanities", target_area:"Rome", video_url: "", video_url_html: "", cover_photo: nil, category_id: charity_categories.find_by_name("International").id}
   charity_emails << "romeAcademy@groupgrant.com"

   charities << {image: "", name: "Children's Cancer Research Fund", eid:411893645, description: "Children's Cancer Research Fund is dedicated to finding a cure for childhood cancer by providing funds to the University of Minnesota for research and training relating to the prevention, treatment and cure of childhood cancer. The organization also educates the public about childhood cancer and supports quality-of-life programs for pediatric cancer patients and their families. Children's Cancer Research Fund focuses on supporting pioneering research initiatives that lead to larger studies, clinical trials and improved methods of treating childhood cancer. Ultimately, it will be the breakthroughs in diagnosis and treatment that help prevent childhood cancer.",
   mission_statement:"Finding a cure for childhood cancer", target_area:"USA", video_url: "", video_url_html: "", cover_photo: nil, category_id: charity_categories.find_by_name("Health").id}
   charity_emails << "cancerresearch@groupgrant.com"
...
business_emails = []
   ...
   businesses << { image: "pic22", name: "Apple Inc.", description: "Apple Inc. is an American multinational corporation headquartered in Cupertino, California, that designs, develops, and sells consumer electronics, computer software and personal computers. Its best-known hardware products are the Mac line of computers, the iPod media player, the iPhone smartphone, and the iPad tablet computer. Its consumer software includes the OS X and iOS operating systems, the iTunes media browser, the Safari web browser, and the iLife and iWork creativity and productivity suites.",
     location:"", goods: "", services:"", interests:"", category_id: BusinessCategory.find_by_name("Electronics").id}
   business_emails << "apple@groupgrant.com"
